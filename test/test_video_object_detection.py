...
def test_video_detection_yolov3(): #detection of the video
...
def test_video_detection_tiny_yolov3(): #test the detection of video
...
def test_video_detection_retinanet_analysis(): #retinanet
